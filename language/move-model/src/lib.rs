...
/// Builds the move model with default compilation flags and default options. This calls
/// the move compiler v1 to compile to bytecode first and attach the generated bytecode to
/// the model.
